...
var WebSocketContext = defineClass(function(id, meta, inEvents, prefix) {
    ...
    isOpening: function() { return this.inEvents != undefined &&
    ...
    recv: function() {
        var e = undefined;
        while (e == undefined && this.readIndex < this.inEvents.length) {
            if (['TEXT', 'BINARY', 'CLOSE', 'DISCONNECT'].indexOf(
        ...
        if (e.type == 'TEXT' || e.type == 'BINARY') {
            ...
            if (e.content !== undefined && e.content.length == 2) {
    ...
    subscribe: function(channel) {
        this.sendControl(grip.webSocketControlMessage(this.prefix + 'subscribe',
                {'channel': channel}));
    },
    unsubscribe: function(channel) {
        this.sendControl(grip.webSocketControlMessage(this.prefix + 'unsubscribe',
                {'channel': channel}));
    },
    detach: function() {
